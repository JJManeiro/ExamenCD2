...
public class Factory {
    /**
     * CAMION,BICI y BARCO son int constantes los cuales se usarán para llamar a las clases después.
     */
...
public static Comun Producto (int transporte,String mensaje){
     ...
     * Si es Barco, llama a clase barco como objeto Ba y llama a los métodos que tiene barco.
     */
            if (transporte==CAMION) {
                ...
                Barco Ba = new Barco(mensaje);
                Ba.muestra();
                Ba.embalaje(x,y,z,w,op);
                Ba.coste(cp);
            }
            return null;
    }
